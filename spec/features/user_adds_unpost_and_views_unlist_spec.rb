...
# feature "User adds unlisting and views unlist", { js: true } do
...
#     click_link "add unlisting"
#     add_unlisting_via_form("Civic Si")
...
# def add_unlisting_via_form(item_name)
#   select "#{item_category.name}", from: "Category"
#   fill_in "Title*", with: "#{item_name}"
#   fill_in "Description*", with: "2000 Civic Si"
#   select "#{item_category.conditions.first.level}", from: "unlisting_condition_select"
...
#   find(:css, "#unlisting_travel").set(true)
#   select "25", from: "Distance"
#   fill_in "Zipcode", with: "98052"
#   click_button "Create Unlisting"
# end

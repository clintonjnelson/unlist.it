...
# As of 9/8/2014, using the following versions:
#----------------------------------------------
# Using rake 10.3.2
# Using i18n 0.6.9
# Using json 1.8.1
...
# Using rails 4.1.1
# Using dropzonejs-rails 0.4.16
# Using email_validator 1.4.0
# Using eventmachine 1.0.3
# Using excon 0.37.0
# Using fabrication 2.11.2
# Using faker 1.3.0
...
# Using video_info 2.3.1
# Using link_thumbnailer 2.2.3
# Using subexec 0.2.3
# Using mini_magick 3.7.0
# Using netrc 0.7.7
# Using newrelic_rpm 3.9.3.241
# Using rendezvous 0.0.2
# Using paratrooper 2.4.1
# Using pg 0.17.1
